...
| **FlutterFlow MarketPlace Project** | Architected and developed an e-commerce application using FlutterFlow with Supabase backend. The solution supports two user roles — Customers and Suppliers — using Supabase Auth with RLS for secure access control. Customers can browse and purchase products, while Suppliers can add and manage inventory. Data is managed via Supabase Database (Users, Products, Orders tables) and Supabase Storage handles product images. Designed the full system diagram, implemented custom queries, role-based conditional UI, and set up Trello for clear project timelines and DevOps tasks.[View the Project Architecture](https://drive.google.com/file/d/19U3oQad-13moByA_SQiINaEHIxfv6PTV/view?usp=sharing) | FlutterFlow, Supabase Auth, Supabase Database, Supabase Storage, Role-Based Access Control (RLS), Trello, Dart code.|
